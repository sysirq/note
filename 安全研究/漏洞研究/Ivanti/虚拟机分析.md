...
__int64 __fastcall populate_rootfs(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  ...
  if ( initrd_start )
  {
    ...
    if ( v19 <= 0xFFFFFFFFFFFFF000LL )
    {
      ...
      (*(void (__fastcall **)(unsigned __int64, _DWORD *, __int64))(v19 + 8))(v19, v43, 16LL);//cia_setkey
      v23 = 0;
      while ( v14 > 0x1FF )
      {
        v14 -= 512LL;
        ...
        *(_QWORD *)((char *)&v44 + 4) = 0LL;
        ...
        HIDWORD(v44) = 0;
        v25 = v24 + 128;
        (*(void (__fastcall **)(unsigned __int64, _DWORD *, __int128 *))(v19 + 24))(v19, v45, &v44);//cia_decrypt
        do
        {
          *v24 ^= v45[0];
          v24[1] ^= v45[1];
          ...
          v24[3] ^= v45[3];
          v41 = *(_OWORD *)v24;
          (*(void (__fastcall **)(unsigned __int64, _DWORD *, _DWORD *))(v19 + 24))(v19, v24, v24);//cia_decrypt
          *v24 ^= v44;
          v24[1] ^= DWORD1(v44);
          v24[2] ^= DWORD2(v44);
          v24[3] ^= HIDWORD(v44);

...
for addr in address:
    ...
    if data[38] != 0x5e:
        continue
    input_data = addr + 18 + int.from_bytes(data[14:18], byteorder='little', signed=True)
    input_len  = int.from_bytes(data[19:23], byteorder='little', signed=True)
    ...
    print("input_data addr:",hex(input_data))
    print("input_len:",hex(input_len))

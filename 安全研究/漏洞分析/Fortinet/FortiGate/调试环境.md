...
root@sysirq-machine:/home/sysirq/Work/Fortinet/rootfs/tmp# find . | cpio --quiet -H newc -o | gzip -9 -n > ../initrd.cpio.gz
...
output_initrd_name="rootfs.decrypt.gz.out" # 加密后的initrd
...
qemu-nbd --connect=/dev/nbd0 path_to_your.qcow2
fdisk -l /dev/nbd0

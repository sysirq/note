...
```c
__int64 __fastcall sub_2A9EDB0(char *haystack, __int64 a2, __int64 a3)
{
  char *v4; // r12
  char *v5; // rax
  char *v6; // rbx
  ...
  *(_QWORD *)(a3 + 160) = 0LL;
  memset(
    ...
    0,
    8LL * (((unsigned int)a3 - (((_DWORD)a3 + 8) & 0xFFFFFFF8) + 168) >> 3));
  *(_BYTE *)(a3 + 160) = 1;
  if ( haystack )
  {
...
LABEL_42:
                    ...
                    *(_BYTE *)(a3 + 161) = ptra;
                    if ( v34 )
                    {
                      ...
                      if ( v35 )
                      {
                        if ( (unsigned int)sub_2A9D6A0(v35, (__int64)v34) == 1 )
                          *(_BYTE *)(a3 + 162) = 1;
                        v34 = *(const char **)a3;
                      }
                      for ( i = 0LL; i != 21; ++i )
                      {
                        if ( !strncmp(v34, (&off_4873480)[2 * i], 6uLL) )
                        {
                          v32 = 0;
                          *(_DWORD *)(a3 + 80) = dword_4873488[4 * (int)i];
                          goto LABEL_51;
                        }
                      }
                      v32 = -1;
LABEL_51:
                      if ( !ptra || (v37 = *(_DWORD *)(a3 + 80), v37 == 1) || v37 == 22 )
                      {
                        if ( *(_QWORD *)(a3 + 48) )
                        {
                          sub_2A80330(&v44);
                          sub_2A9D030(*(char **)(a3 + 48), (__int64)key);
...
LABEL_33:
                        sub_2A9ECC0(a3, key, flag, value, value_len);
                        goto LABEL_34;
                      }
                    }
                    else
